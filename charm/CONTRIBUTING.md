...
```
git clone https://github.com/__REPO_PATH__
```
...
Use [Rockcraft](https://documentation.ubuntu.com/rockcraft/stable/) to create an OCI image for the __CHARM_NAME__ app,
